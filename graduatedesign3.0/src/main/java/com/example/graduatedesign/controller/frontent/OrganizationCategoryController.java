...
@Controller
@Slf4j
@RequestMapping("/frontend/organizationCategory")
...
public class OrganizationCategoryController {
    ...
    public Map<String,Object> getall()
    {
        ...
        List<OrganizationCategory> organizationCategoryList=null;
        try
        {
            organizationCategoryList=organizationCategoryService.findAll();
            map.put("organizationCategoryList",organizationCategoryList);
